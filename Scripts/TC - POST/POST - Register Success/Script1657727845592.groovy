...
response = WS.sendRequest(findTestObject('POST/POST - Register Success', [('email') : email, ('password') : password, ('id') : id]))
...
WS.verifyElementPropertyValue(response, 'token', result.token)
