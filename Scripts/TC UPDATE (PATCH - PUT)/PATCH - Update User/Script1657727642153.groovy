...
response = WS.sendRequest(findTestObject('PUT-PATCH/PATCH - Update User', [('name') : name, ('job') : job, ('userId') : userId]))
...
WS.verifyElementPropertyValue(response, 'updatedAt', result.updatedAt)
